...
def currency_data_instance():
    ...
    return CurrencyData(
        pair="BRLBTC", mms_20=0.2, mms_50=0.5, mms_200=2.0, timestamp=timezone.now()
    )
...
def test_currency_data_serializer_timestamp(currency_data_instance):
    ...
    serializer = CurrencyDataSerializer(
        instance=currency_data_instance, context=context
    )
...
def test_currency_data_serializer_mms(currency_data_instance):
    ...
    serializer_20 = CurrencyDataSerializer(
        instance=currency_data_instance, context=context_20
    )
    ...
    serializer_50 = CurrencyDataSerializer(
        instance=currency_data_instance, context=context_50
    )
    ...
    serializer_200 = CurrencyDataSerializer(
        instance=currency_data_instance, context=context_200
    )
